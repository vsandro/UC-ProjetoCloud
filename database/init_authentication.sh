...
INSERT INTO "arquitetura_authentication"."profiles" VALUES ('0cd9f2ff-df2c-49e8-a5db-976aa757c501', 'Usuario');
...
-- ----------------------------
CREATE UNIQUE INDEX "users_email_key" ON "arquitetura_authentication"."users" USING btree (
